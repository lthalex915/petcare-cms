...
export default function SettingsPage() {
    ...
    return (_jsxs("div", { className: "page-card", children: [_jsx("h1", { style: { marginTop: 0, fontSize: 20 }, children: "LLM API Configuration" }), _jsxs("div", { style: { marginBottom: 16, padding: 12, border: "1px solid #ddd", background: "#fafafa" }, children: [_jsx("div", { style: { fontWeight: 700, marginBottom: 8 }, children: "Admin Mode" }), _jsxs("label", { style: { display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }, children: [_jsx("input", { type: "checkbox", checked: adminMode, onChange: (e) => setAdminMode(e.target.checked) }), "Enable admin mode for editing/deleting pets, daily logs, and reports"] })] }), _jsxs("div", { className: "form-grid", style: { marginBottom: 12 }, children: [_jsxs("select", { value: config.provider, onChange: (e) => setConfig((prev) => ({ ...prev, provider: e.target.value })), children: [_jsx("option", { value: "OPENROUTER", children: "OpenRouter" }), _jsx("option", { value: "OPENAI_COMPAT", children: "OpenAI Compatible" })] }), _jsx("input", { value: config.apiBaseUrl, onChange: (e) => setConfig((prev) => ({ ...prev, apiBaseUrl: e.target.value })), placeholder: "API Base URL" }), _jsxs("div", { style: { gridColumn: "1 / -1", display: "flex", gap: 8 }, children: [_jsx("input", { style: { flex: 1 }, type: showKey ? "text" : "password", value: config.apiKey, onChange: (e) => setConfig((prev) => ({ ...prev, apiKey: e.target.value })), placeholder: "API Key" }), _jsx("button", { type: "button", onClick: () => setShowKey((v) => !v), style: { border: "1px solid #000", background: "#fff", padding: "8px 12px" }, children: showKey ? "Hide" : "Show" })] }), _jsx("input", { value: config.defaultModel, onChange: (e) => setConfig((prev) => ({ ...prev, defaultModel: e.target.value })), placeholder: "Default model" }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [_jsx("label", { style: { minWidth: 80 }, children: "Temperature" }), _jsx("input", { type: "range", min: 0, max: 1, step: 0.1, value: config.temperature, onChange: (e) => setConfig((prev) => ({ ...prev, temperature: Number(e.target.value) })) }), _jsx("span", { children: config.temperature.toFixed(1) })] }), _jsx("input", { value: String(config.maxTokens), onChange: (e) => setConfig((prev) => ({ ...prev, maxTokens: Number(e.target.value) || 0 })), placeholder: "Max tokens", type: "number" })] }), _jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("button", { type: "button", onClick: testConnection, disabled: testing, style: { border: "1px solid #000", background: "#fff", padding: "10px 16px" }, children: testing ? "Testing..." : "Test Connection" }), _jsx("button", { type: "button", onClick: save, disabled: saving, style: { border: "none", background: "#000", color: "#fff", padding: "10px 16px" }, children: saving ? "Saving..." : "Save Configuration" })] }), result && _jsx("div", { style: { marginTop: 12, fontWeight: 700 }, children: result })] }));
}
